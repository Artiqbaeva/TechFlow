...
export default function Navbar() {
    ...
    return (
        <nav className="fixed top-0 left-0 right-0 z-50 bg-gradient-to-r from-[#F9FAFB] to-[#F5F4F7] w-full">
            <div className="max-w-[1440px] px-[20px] md:px-[60px] lg:px-[175px] mx-auto relative">
