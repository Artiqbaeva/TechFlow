    ...
    return (
        <section id="problems" className="py-24 bg-white overflow-hidden">
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="relative w-full max-w-4xl mx-auto h-[250px] sm:h-[300px] flex items-center justify-center mb-16">
                    <img src="/problems.svg" alt="" />
                </div>

                <div className="grid md:grid-cols-3 gap-8 text-center sm:text-left px-4">
