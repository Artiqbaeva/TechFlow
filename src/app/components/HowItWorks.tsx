...
const steps = [
    {
        id: "1",
        title: "Мижоз қабули",
        description: "Мижозни рўйхатга олиш,ариза очиш",
    ...
    },
    {
        id: "2",
        title: "Диагностика",
        description: "Эҳтиёт қисмларини белгилаш",
        iconColor: "bg-[#F33959]",
    ...
    },
    {
        id: "3",
        title: "Иш жараёни",
        description: "Усталар ишини назорат қилиш",
    ...
    },
    {
        id: "4",
        title: "Тўлов",
        description: "Чек ва кафолат талонларини бериш",
    ...
    },
    {
        id: "5",
        title: "Таҳлил",
        description: "Таҳлил асосида фойдани кўриш",
            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                ...
                <div className="text-center max-w-2xl mx-auto mb-20 text-white">
                    <h2 className="text-[32px] sm:text-[36px] font-bold tracking-tight">
                        Иш жараёни қандай ишлайди?
                    </h2>
                    <p className="mt-4 text-[#8B93A5] font-medium text-[15px] sm:text-base leading-relaxed">
                        TechFlow сервисдаги барча жараёнларни 5 аниқ қадамга <br className="hidden sm:block" /> бўлади ва назорат қилади.
                    </p>
                </div>
